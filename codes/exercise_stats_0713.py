...
# 构建文件路径
input_file = os.path.join(code_dir, "../datas/output/fitness_records_2023-07-13.txt")
output_file = os.path.join(code_dir, "../datas/output/exercise_stats_2023-07-13.md")
