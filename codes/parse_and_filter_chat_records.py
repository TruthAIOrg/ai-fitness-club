...
# 构建文件路径
input_file = os.path.join(code_dir, "../datas/db_msg_all/Chat_74b5432e6a566cac0f58f1688b8f1429.json")
output_file = os.path.join(code_dir, "../datas/output/fitness_records_2023-06.txt")
